...
pagebuilderSplide-main.zip
zip

Rewrite the readme for this

09:09

Ran 2 commands, viewed a file
Ran 2 commands, viewed a file
Now I have a full picture of all three files. Let me write a clear, accurate readme.
...
Intro line updated to better reflect the actual use case (page builder environments)
Files table corrected — the original listed splide.js and splide.css but the actual filenames are initiate.js and styles.css, and there's no splide.html in the package
Dependencies trimmed — Google Fonts and Bootstrap aren't really dependencies of the slider itself
JavaScript API section added, since _mountSplideEl and _splideInstances are exported globals that anyone building on this would need to know about
Splide options table added so it's clear what's hardcoded and not configurable
data-max-width documented — it exists in the CSS but wasn't mentioned at all in the original readme
data-slider-status="mounted" behaviour documented
